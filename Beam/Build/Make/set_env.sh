...
export UNWIND_INCLUDE_PATH=/usr/local/include
export UNWIND_LIBRARY_DEBUG_PATH=/usr/local/lib/libunwind.a
export UNWIND_LIBRARY_OPTIMIZED_PATH=/usr/local/lib/libunwind.a
