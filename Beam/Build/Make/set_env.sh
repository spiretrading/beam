...
export BOOST_PYTHON_LIBRARY_DEBUG_PATH=$BOOST_DEBUG_PATH/libboost_python3.a
export BOOST_PYTHON_LIBRARY_OPTIMIZED_PATH=$BOOST_OPTIMIZED_PATH/libboost_python3.a
