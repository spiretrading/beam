...
export BOOST_PYTHON_LIBRARY_DEBUG_PATH=$BOOST_DEBUG_PATH/libboost_python36.$so_ext
export BOOST_PYTHON_LIBRARY_OPTIMIZED_PATH=$BOOST_OPTIMIZED_PATH/libboost_python36.$so_ext
...
export PYTHON_LIBRARY_DEBUG_PATH=/usr/lib/python3.6/config-3.6m-x86_64-linux-gnu/libpython3.6.$so_ext
export PYTHON_LIBRARY_OPTIMIZED_PATH=/usr/lib/python3.6/config-3.6m-x86_64-linux-gnu/libpython3.6.$so_ext
export SQLITE_INCLUDE_PATH=$beam_local_path/../../../../sqlite
export SQLITE_LIBRARY_DEBUG_PATH=$beam_local_path/../../../../sqlite/sqlite3.lib
export SQLITE_LIBRARY_OPTIMIZED_PATH=$beam_local_path/../../../../sqlite/sqlite3.lib
export TCLAP_INCLUDE_PATH=/usr/local/include
export VIPER_INCLUDE_PATH=$beam_local_path/../../../../viper/Include/
