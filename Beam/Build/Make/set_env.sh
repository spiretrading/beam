...
export CRYPTOPP_INCLUDE_PATH=/usr/include
export CRYPTOPP_LIBRARY_DEBUG_PATH=/usr/lib/libcryptopp.a
export CRYPTOPP_LIBRARY_OPTIMIZED_PATH=/usr/lib/libcryptopp.a
