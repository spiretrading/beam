...
export BOOST_PYTHON_LIBRARY_DEBUG_PATH=$BOOST_DEBUG_PATH/libboost_python3.$so_ext
export BOOST_PYTHON_LIBRARY_OPTIMIZED_PATH=$BOOST_OPTIMIZED_PATH/libboost_python3.$so_ext
...
export PYTHON_LIBRARY_DEBUG_PATH=/usr/lib/python3.5/config-3.5m-x86_64-linux-gnu/libpython3.5.$so_ext
export PYTHON_LIBRARY_OPTIMIZED_PATH=/usr/lib/python3.5/config-3.5m-x86_64-linux-gnu/libpython3.5.$so_ext
