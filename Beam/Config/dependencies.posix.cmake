...
set(BOOST_PYTHON_LIBRARY_DEBUG_PATH "${BOOST_DEBUG_PATH}/libboost_python36.so")
set(BOOST_PYTHON_LIBRARY_OPTIMIZED_PATH
  "${BOOST_OPTIMIZED_PATH}/libboost_python36.so")
...
set(CRYPTOPP_INCLUDE_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/cryptopp565/include")
...
set(LUA_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/lua-5.3.1/install/lib/liblua.a")
set(LUA_LIBRARY_OPTIMIZED_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/lua-5.3.1/install/lib/liblua.a")
set(MYSQL_INCLUDE_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/mysql-connector-c-6.1.11-src/include")
set(MYSQL_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/mysql-connector-c-6.1.11-src/lib/libmysqlclient.a")
set(MYSQL_LIBRARY_OPTIMIZED_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/mysql-connector-c-6.1.11-src/lib/libmysqlclient.a")
set(OPEN_SSL_INCLUDE_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/openssl-1.0.2g/include")
set(OPEN_SSL_BASE_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/openssl-1.0.2g/libcrypto.a")
...
set(YAML_LIBRARY_OPTIMIZED_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/yaml-cpp-0.6.2/build/libyaml-cpp.a")
set(ZLIB_INCLUDE_PATH "${PROJECT_BINARY_DIR}/Dependencies/zlib-1.2.11/include")
set(ZLIB_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/zlib-1.2.11/libz.a")
