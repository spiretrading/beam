...
set(BOOST_INCLUDE_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/boost_1_87_0/include/boost-1_87")
set(BOOST_DEBUG_PATH "${PROJECT_BINARY_DIR}/Dependencies/boost_1_87_0/lib")
set(BOOST_OPTIMIZED_PATH "${PROJECT_BINARY_DIR}/Dependencies/boost_1_87_0/lib")
set(CRYPTOPP_INCLUDE_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/cryptopp890/include")
set(CRYPTOPP_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/cryptopp890/x64/Output/Debug/cryptlib.lib")
set(CRYPTOPP_LIBRARY_OPTIMIZED_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/cryptopp890/x64/Output/Release/cryptlib.lib")
set(MYSQL_INCLUDE_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/mariadb-connector-c-3.4.3/include")
set(MYSQL_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/mariadb-connector-c-3.4.3/libmariadb/Debug/mariadbclient.lib")
set(MYSQL_LIBRARY_OPTIMIZED_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/mariadb-connector-c-3.4.3/libmariadb/Release/mariadbclient.lib")
set(OPEN_SSL_INCLUDE_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/openssl-3.4.0/include")
set(OPEN_SSL_BASE_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/openssl-3.4.0/lib/libcrypto.lib")
set(OPEN_SSL_BASE_LIBRARY_OPTIMIZED_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/openssl-3.4.0/lib/libcrypto.lib")
set(OPEN_SSL_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/openssl-3.4.0/lib/libssl.lib")
...
set(SQLITE_LIBRARY_DEBUG_PATH
  "${PROJECT_BINARY_DIR}/Dependencies/sqlite-amalgamation-3480000/sqlite3d.lib")
