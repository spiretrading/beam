#ifndef BEAM_CONVERSIONEVALUATORNODE_HPP
#define BEAM_CONVERSIONEVALUATORNODE_HPP
#include <utility>
...
namespace Details {
  ...
  */
  ...
  std::unique_ptr<FunctionEvaluatorNode<Details::CastFunctor<Source, Target>>>
    ...
    return MakeFunctionEvaluatorNode(Details::CastFunctor<Source, Target>{},
      std::move(arg));
  }
  ...
  */
  template<typename Source, typename Target, typename Arg>
  std::unique_ptr<FunctionEvaluatorNode<
      Details::ConstructFunctor<Source, Target>>> MakeConstructEvaluatorNode(
