...
namespace Details {
  ...
  inline bool install_handler() {
    ::signal(SIGINT, Details::ctrl_handler);
    ::signal(SIGTERM, Details::ctrl_handler);
    return true;
  }
}
  ...
  inline bool is_running() {
    static auto initialize_control_handler = Details::install_handler();
