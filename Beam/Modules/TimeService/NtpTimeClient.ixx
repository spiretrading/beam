...
export namespace Beam {
  ...
  inline constexpr auto NTP_PACKET_SIZE = 48 * sizeof(std::uint8_t);

  /** The offset to the first byte of the NTP packet's origin timestamp. */
  inline constexpr auto ORIGIN_TIMESTAMP_OFFSET = std::size_t(24);

  /** The offset to the first byte of the NTP packet's receive timestamp. */
  inline constexpr auto RECEIVE_TIMESTAMP_OFFSET = std::size_t(32);

  /** The offset to the first byte of the NTP packet's transmit timestamp. */
  inline constexpr auto TRANSMIT_TIMESTAMP_OFFSET = std::size_t(40);
