...
def build_repo(repo, name, ftp_site, username, password):
  ...
  for commit in commits:
    ...
    log_file.close()
    applications = ['AdminClient', 'ClientTemplate', 'DataStoreProfiler',
      'HttpFileServer', 'QueryStressTest', 'RegistryServer', 'ServiceLocator',
      'ServiceProtocolProfiler', 'ServletTemplate', 'UidServer',
      'WebSocketEchoServer']
